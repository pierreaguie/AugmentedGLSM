...
from CPC_loader import load_cpc_features, build_feature_from_file, FeatureModule
...
def parse_args(argv):
    ...
    parser.add_argument("--custom_model", type=str, default=None,
                        help="Specifies if we have a custom model(then we only apply torch.load)")
